...
<div>
    ...
    <form class="form-inline" method="GET" action="{{ route('filter') }}"" >
        <div class="input-group">
            <select class="form-select"name="country" id="inputGroupSelect04" aria-label="Example select with button addon">
...
<table class="table table-bordered data-table">
    <thead>
        <tr>
            ...
            <th style="text-align:center" scope="col" @sortablelink('name', 'School Name')</th>
